...
public class EasyTransitionOptions {
    ...
    public void update() {
        ...
        for (View v : views) {
            ...
            attrs.add(new ViewAttrs(v.getId(), location[0], location[1], v.getWidth(), v.getHeight()));
        }
    }
    ...
    public static class ViewAttrs implements Parcelable {
        ...
        public static final Parcelable.Creator<ViewAttrs> CREATOR = new Creator<ViewAttrs>() {
            @Override
